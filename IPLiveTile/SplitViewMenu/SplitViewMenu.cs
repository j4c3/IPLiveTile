...
namespace SplitViewMenu
{
    public sealed class SplitViewMenu : Control
    {
        internal static readonly DependencyProperty MenuItemDataTemplateSelectorProperty =
            DependencyProperty.Register("MenuItemDataTemplateSelector", typeof(DataTemplateSelector), typeof(SplitViewMenu),
        ...
        internal static readonly DependencyProperty NavigationItemsProperty =
            DependencyProperty.Register("NavigationItems", typeof(IEnumerable<ISplitViewMenuItem>), typeof(SplitViewMenu),
                new PropertyMetadata(Enumerable.Empty<ISplitViewMenuItem>(), OnNavigationItemsPropertyChanged));

        internal static readonly DependencyProperty FrameHeaderProperty =
            DependencyProperty.Register("FrameHeader", typeof(object), typeof(SplitViewMenu), 
                new PropertyMetadata(null));

        private SplitViewMenuListView _navMenuListView;
        ...
        public IEnumerable<ISplitViewMenuItem> NavigationItems
        {
            get { return (IEnumerable<ISplitViewMenuItem>)GetValue(NavigationItemsProperty); }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _navMenuListView = GetTemplateChild("NavMenuList") as SplitViewMenuListView;
        ...
        {
            if (!args.InRecycleQueue && args.Item is ISplitViewMenuItem)
            {
                args.ItemContainer.SetValue(AutomationProperties.NameProperty, ((ISplitViewMenuItem)args.Item).Label);
            }
            else
            {
        ...
        private void OnNavigatedToPage(object sender, NavigationEventArgs e)
        {
            ...
            if (page != null && e.Content != null)
            {
                ...
                FrameHeader = item.FrameHeaderLabel;
            }          
        }
        ...
        {
            var item = (ISplitViewMenuItem)((SplitViewMenuListView)sender).ItemFromContainer(e);
